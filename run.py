...
def three_days_per_wk_full_body_muscle_building_program():
    ...
    print("\tRear Delt Flies,               1-3 sets, 5-8 reps, 2-3 mins rest")
...
def strength_building_program():
    ...
    print("Please enter the weight you lifted (in kg's)\nand for "
          ...
          "a Squat,\nBench, and Deadlift\n")
    print("If you have not used any of these exercises\nplease first "
          "spend a few sessions\nperforming them and come back to "
          "this section to get\nan accurate starting weight\n")
    while True:
        try:
            print("Squat:")
